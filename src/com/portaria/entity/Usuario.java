 ...
 */
@Entity
@Table(name = "usuario", catalog = "portaria", schema = "")
@NamedQueries({
    @NamedQuery(name = "Usuario.findAll", query = "SELECT u FROM Usuario u"),
    @NamedQuery(name = "Usuario.findByCodigo", query = "SELECT u FROM Usuario u WHERE u.idusuario = :idusuario"),
...
public class Usuario implements Serializable {
    ...
    public String toString() {
        return "com.portaria.model.Usuario[ idusuario=" + idusuario + " ]";
    }
