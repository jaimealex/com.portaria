...
public class UsuarioDAOImpl implements UsuarioDAO<Usuario> {
    ...
    public Usuario findByLoginSenha(String login, String senha) {
        ...
        ParameterExpression<String> paramLogin
                = builder.parameter(String.class, "login");
        ParameterExpression<String> paramSenha
                = builder.parameter(String.class, "senha");
        predicates.add(builder.equal(usuario.get("login"),
                paramLogin));
        predicates.add(builder.equal(usuario.get("senha"),
                paramSenha));
